...
*/
game.party.push(pokemon[17], pokemon[9], pokemon[29])
...
*/
game.party.splice(0,1,game.party[1])
console.log("Excercise 6:", game.party);


// Check the updated party
...
game.party.forEach((pokemon) => {
  console.log("Excercise 8:",pokemon.name);
})
...
for (let i = 0; i < length; i++) {
  if (pokemon[i].starter) {
    console.log("Excercise 9:", pokemon[i].name);
  }
}
...
console.log("Excrecise 10:", game.party)
/*
Exercise 11
...
console.log("Excercise 11:", game.items, ...game.party);
